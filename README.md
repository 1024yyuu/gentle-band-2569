...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/gentle-band-2569)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/gentle-band-2569
```

A live public deployment of this template is available at [https://gentle-band-2569.templates.workers.dev](https://gentle-band-2569.templates.workers.dev)
